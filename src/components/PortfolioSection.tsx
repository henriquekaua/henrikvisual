...
const portfolioItems: Record<Category, Item[]> = {
  video: [
    { id: 1, title: "Álbum Copa do Mundo 2026", subtitle: "Para Panini", description: "Vídeo promocional do álbum de figurinhas da Copa do Mundo FIFA 2026.", thumbnail: video1, type: "video", videoUrl: video1 },
    { id: 22, title: "Dicas para Morar no Exterior", subtitle: "Para Remessa Online", description: "Rubinho Barrichello, em parceria com a Remessa Online, dá dicas para quem deseja morar fora do país.", thumbnail: rubinho, type: "video", videoUrl: rubinho },
    { id: 21, title: "Lançamento Ace", subtitle: "Para Ace", description: "Campanha de lançamento de roupas fitness, com cenas em movimento reforçando o estilo da marca.", thumbnail: acePilula2, type: "video", videoUrl: acePilula2 },
    { id: 2, title: "Um Lar Para Chamar de Seu", subtitle: "Para Antares Imóveis", description: "Produção autoral simulando a divulgação de um imóvel, como exercício de estudo.", thumbnail: video2, type: "video", videoUrl: video2 },
    { id: 3, title: "Trend Copa do Mundo 2026", subtitle: "Para Panini", description: "Cobertura de uma trend viral em torno da Copa do Mundo 2026.", thumbnail: video3, type: "video", videoUrl: video3 },
    { id: 4, title: "Black November", subtitle: "Para Strong Body", description: "Campanha promocional da Black November 2025 da Strong Body.", thumbnail: video4, type: "video", videoUrl: video4 },
  ],
  motion: [
    { id: 7, title: "Electric Wave", subtitle: "Para Strong Body", description: "Vídeo de lançamento do pré-treino Electric Wave.", thumbnail: motion1, type: "video", videoUrl: motion1 },
    { id: 8, title: "Próximos Shows", subtitle: "Para Natanzinho Lima", description: "Divulgação da agenda de próximos shows do Natanzinho Lima.", thumbnail: motion2, type: "video", videoUrl: motion2 },
    { id: 9, title: "Uso da Creatina", subtitle: "Para Strong Body", description: "Conteúdo educativo sobre o uso correto da creatina.", thumbnail: motion3, type: "video", videoUrl: motion3 },
    { id: 10, title: "Dia Mundial do Livro", subtitle: "Para Panini", description: "Peça comemorativa em celebração ao Dia Mundial do Livro.", thumbnail: motion4, type: "video", videoUrl: motion4 },
    { id: 11, title: "Direção de Arte, Além da Estética", subtitle: "Para Zafenate Design", description: "Explicando o real papel da direção de arte na construção de marcas.", thumbnail: motion5, type: "video", videoUrl: motion5 },
    { id: 12, title: "20 Minutos é o Tempo Necessário", subtitle: "Para Nombrare", description: "Divulgação dos serviços de registro de marca.", thumbnail: motion6New, type: "video", videoUrl: motion6New },
    { id: 19, title: "Um Pouco Sobre Neymar Jr.", subtitle: "Para Henrik Visual", description: "Um recorte da trajetória do Neymar, produzido como exercício autoral.", thumbnail: motion7, type: "video", videoUrl: motion7 },
    { id: 20, title: "Humberto & Ronaldo ao Vivo", subtitle: "Para Rodeio de Tabatinga 2025", description: "Chamada para o show de Humberto & Ronaldo no Rodeio de Tabatinga 2025.", thumbnail: motion6Old, type: "video", videoUrl: motion6Old },
  ],
  design: [
    { id: 13, title: "Hokori Sushi", thumbnail: hokori1, type: "image", clientSlug: "hokori-sushi" },
    { id: 15, title: "PG Imports", thumbnail: pgEuropeu, type: "image", clientSlug: "pg-imports" },
    { id: 16, title: "Buff Smurfs", thumbnail: buff1, type: "image", clientSlug: "buff-smurfs" },
    { id: 30, title: "Thumbnails", thumbnail: thumbYasuo, type: "image", clientSlug: "thumbnails" },
  ],
  web: [],
};
...
const webProjects: WebProject[] = [
  {
    ...
    thumbnail: danmorganDesktop,
    mobilePreview: danmorganDesktop,
